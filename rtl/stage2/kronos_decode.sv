...
// kronos_decode.sv (stage2) — RV32I+M instruction decoder.
// Extends the stage0 decoder: the OP opcode now recognises funct7=0000001
// as M-extension multiply/divide operations.
    ...
    unique case (opcode)
      OP: begin  // R-type: ADD, SUB, SLL, SLT, SLTU, XOR, SRL, SRA, OR, AND + M-ext
        ...
        if (funct7 == 7'b000_0001) begin
          ...
          // funct3 directly encodes muldiv_op_e (same numeric mapping)
